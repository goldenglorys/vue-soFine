...
<template>
        ...
        <div class="view" style="background-image: url('./assets2/img/caro1.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="mask rgba-black-light d-flex justify-content-center align-items-center">
            ...
            <div class="text-center white-text mx-5 wow fadeIn">
              ...
              <p>
                <strong>Get Your Jobs Done</strong>
              </p>
  ...
  <main>
    ...
    <section>
        ...
        <h2 class="my-5 h3 text-center">Categories</h2>
        ...
        <div class="row features-small mt-5 wow fadeIn">
          ...
          <div class="col-xl-3 col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-10 mb-2 pl-3">
                <h5 class="feature-title font-bold mb-1">Native Tailor</h5>
                <p class="grey-text mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
                </p>
              </div>
            </div>
            <!--/Grid row-->
          ...
          <div class="col-xl-3 col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-10 mb-2 pl-3">
                <h5 class="feature-title font-bold mb-1">Coparate Tailor</h5>
                <p class="grey-text mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
                </p>
              </div>
            </div>
          ...
          <div class="col-xl-3 col-lg-6">
            ...
            <div class="row">
             <div class="col-2">
              ...
              <div class="col-10 mb-2 pl-3">
                <h5 class="feature-title font-bold mb-1">Suit Tailor</h5>
                <p class="grey-text mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
                </p>
              </div>
            </div>
          ...
          <div class="col-xl-3 col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-10 mb-2 pl-3">
                <h5 class="feature-title font-bold mb-1">Designer</h5>
                <p class="grey-text mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
                </p>
              </div>
            </div>
        ...
        <div class="row features-small mt-4 wow fadeIn">
          ...
          <div class="col-xl-3 col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-10 mb-2 pl-3">
                <h5 class="feature-title font-bold mb-1">Material Seller</h5>
                <p class="grey-text mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
                </p>
              </div>
            </div>
          ...
          <div class="col-xl-3 col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-10 mb-2 pl-3">
                <h5 class="feature-title font-bold mb-1">Customizer</h5>
                <p class="grey-text mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
                </p>
              </div>
            </div>
          ...
          <div class="col-xl-3 col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-10 mb-2 pl-3">
                <h5 class="feature-title font-bold mb-1">Cap Tailor</h5>
                <p class="grey-text mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
                </p>
              </div>
            </div>
          ...
          <div class="col-xl-3 col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-10 mb-2 pl-3">
                <h5 class="feature-title font-bold mb-1">Casual Tailor</h5>
                <p class="grey-text mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
                </p>
              </div>
            </div>
      ...
      <section>
        ...
        <h3 class="h3 text-center mb-5">About SoFine</h3>
        ...
        <div class="row wow fadeIn">
          ...
          <div class="col-lg-6 col-md-12 px-4">
            ...
            <div class="row">
              ...
              <div class="col-10">
                <h5 class="feature-title">Fast And Easy</h5>
                <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
              </div>
            </div>
            <!--/First row-->
            ...
            <div class="row">
              ...
              <div class="col-10">
                <h5 class="feature-title">Super Delivery</h5>
                <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
              </div>
            </div>
            <!--/Third row-->
      ...
      <section>
        ...
        <h2 class="my-5 h3 text-center">SoFine Guide</h2>
        ...
        <div class="row features-small mb-5 mt-3 wow fadeIn">
          ...
          <div class="col-md-4 flex-center">
            <img src="/assets2/img/guid.jpg" alt="guid" class="z-depth-0 img-fluid">
          </div>
          <!--/Second column-->
      ...
      <section class="mt-5 wow fadeIn">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-4">
            ...
            <img src="/assets2/img/gig.jpg" class="img-fluid z-depth-1-half" alt="gig">
          ...
          <div class="col-md-6 mb-4">
            ...
            <!-- Main heading -->
            <h3 class="h3 mb-3">Most Popular Gig</h3>
            ...
            <!-- CTA -->
            <a target="_blank" href="#" class="btn btn-indigo btn-md">See More Gigs
  ...
  <footer class="page-footer text-center font-small mt-4 wow fadeIn">
    ...
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-4">
            <div class="foot-one"><b>Categories</b></div>
            <span>Native Tailors</span> <br>
            <span>Suit Tailors</span> <br>
            <span>Corporate</span> <br>
            <span>Cap Tailors</span> <br>
            <span>Designers</span> <br>
            <span>Casual Tailors</span> <br>
            <span>Customiser</span> <br>           
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-3">
            <div class="foot-one"><b>About</b></div>
            <span>Careers</span> <br>
            <span>Press & News</span> <br>
            <span>Intellectual Property Claims</span> <br>
            <span>Terms of Service</span> <br>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-3">
              <div class="foot-one"><b>Support</b></div>
              <span>Contact Support</span> <br>
            <span>Help & Education</span> <br>
            <span>Trust & Safety</span> <br>
            <span>Selling on Beta</span> <br>
            <span>Buying on Beta</span> <br>           
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-3">
                <div class="foot-one"><b>Privacy Policy</b></div>
                <span>Policy</span> <br>
            <span>Partnerships</span> <br>
            <span>Exclusive Benefits</span> <br>
              </div>
              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-3">
                  <div class="foot-one"><b>Community</b></div>
            <span>Events</span> <br> 
            <span>Blogs</span> <br> 
            <span>Forum</span> <br> 
            <span>Podcast</span> <br> 
    ...
    <div class="footer-copyright py-3">
      ©
      <a href="https://mdbootstrap.com/bootstrap-tutorial/" target="_blank"> Beta-Tailor-Team-2018</a>
    </div>
    <!--/.Copyright-->
